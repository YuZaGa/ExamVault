...
async function extractPyqSets() {
  ...
  console.log('Parsing PAPER-1 (2021-2023)PYQs.pdf pages...');
  ...
  console.log(`Found ${diSets.length} DI sets in PYQs:`);
...
extractPyqSets().catch(console.error);
